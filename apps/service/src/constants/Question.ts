...
const CommonQuestion = [
  {
    ...
    url: '/qna/detail/0',
    title: '스크럼은 무엇인가요?',
    desc: '스크럼은 소프트웨어 개발 프로세스 중 하나로, 팀 기반으로 작업을 진행하며 반복적이고 점진적인 방식을 채택합니다.\n\n스크럼을 통해서 각자의 작업 내용을 공유하며 꾸준히 성장하는 환경을 제공합니다.\n\nGDSC UOS에서는 매일 특정 시간에 비대면으로 모여, 하루의 작업 내용을 팀원들과 공유하는 활동을 가집니다.',
  },
  {
    id: '1',
    type: 'common',
    url: '/qna/detail/1',
    title: '어느 팀에 지원할 수 있나요?',
    desc: '이번 Recruiting 에서는 Frontend(Web) 팀과 Mobile 팀에 대해서만 모집을 받고 있습니다.',
  },
  {
    id: '2',
    type: 'common',
    ...
    desc: '이번 Recruit은 3월 24일까지 서류를 마감합니다.\n\n3월 26일에 합격 불합격 상관없이 서류 결과 발표를 진행합니다.\n\n 3월 27일부터 3월 31일까지 인터뷰 비대면 면접을 진행하며, 4월 3일에 최종 결과를 알려드립니다.',
  },
  {
    id: '3',
    type: 'common',
...
const FrontQuestion = [
  {
    ...
    desc: '못해도 괜찮습니다.\n\n단지, 열정적인 모습과 함께 성장할 수 있는 사람을 선호합니다.',
  },
  {
    id: '102',
    type: 'frontend',
