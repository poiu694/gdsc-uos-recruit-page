...
const CommonQuestion = [
  ...
  },
  {
    ...
    desc: '프로젝트 활동은 곧 모르는 걸 자신의 것으로 만드는 활동을 의미합니다. 매일 꾸준히 실천하며 남기는 발자국들은 멋진 결과물로 이어질 것이고, 이는 곧 ‘무엇이든지 할 수 있다’는 자신감이 돼 돌아옵니다. 여러분도 이런 프로젝트의 매력에 빠지시길 바라며 권장합니다.',
  },
  {
    id: '3',
    type: 'common',
    ...
    desc: '데일리 스크럼은 매일매일 꾸준히, 성실하게 진행해야 하는 활동입니다. 물론 하루도 빠짐없이 활동에 참여하는 게 쉬운 일은 아니지만, 지속적인 소통을 통해 서로의 인사이트를 나누다 보면 공부 기록과 개발 과정이 자연스럽게 정리되고, 어느새 서로 자극이 될 만큼 성장해있을 것입니다. 또, 그 과정에서 동료와 쌓이는 유대감은 여러분에게 GDSC 커뮤니티 일원으로서 자부심을 안겨줄 겁니다.',
  },
  {
    id: '4',
    type: 'common',
